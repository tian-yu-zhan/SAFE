...
for (scen.ind in 1:28){
  ...
  stats.sigma.mat[1:2, 1:2] = cor.stats.num.v
  stats.sigma.mat[3:15, 3:15] = cor.stats.num.v
  diag(stats.sigma.mat) = 1
...
write.csv(final.out.mat, paste0("safe_cor_2_nr_", n.r, ".csv"))
}
...
data.output = data.frame(read.csv("safe_cor_2_nr_5.csv")[,-1])
